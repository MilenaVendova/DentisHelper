...
Partial Public Class tbShade
    ...
    <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),
    Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>
    Default Public ReadOnly Property Item(ByVal index As Integer) As tbShadeRow
        Get
    ...
    Public Overrides Function Clone() As Global.System.Data.DataTable
        Dim cln As tbShade = CType(MyBase.Clone, tbShade)
        cln.InitVars()
        Return cln
    End Function
    ...
    Public Sub RemovetbShadeRow(ByVal row As tbShadeRow)
        Me.Rows.Remove(row)
    End Sub
    Private _ta As tbShadeTableAdapter
    Private _dbrm As dbrm

    Public ReadOnly Property TableAdapter() As tbShadeTableAdapter
        Get
            If _ta Is Nothing Then
                _ta = New tbShadeTableAdapter
            End If
            Return _ta
        End Get
    End Property
    ...
    Partial Public Class tbShadeTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "exec sp_tbShade_D @Original_ShadeID"
            ...
            Me._adapter.InsertCommand.CommandText = "DECLARE @RETURN_VALUE INT; exec @RETURN_VALUE = sp_tbShade_I  @Shade; " &
            "SELECT ShadeID , Shade " &
            "FROM tbShade " &
            "WHERE ShadeID = @RETURN_VALUE"
            ...
            Me._adapter.UpdateCommand.CommandText = "exec sp_tbShade_U @ShadeID, @Shade, @Original_Shade; " &
            "SELECT ShadeID , Shade " &
            "FROM tbShade " &
            "WHERE ShadeID = @ShadeID"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "sp_tbShade_S"
        ...
        Public Overridable Overloads Function Fill(ByVal dataTable As tbShade) As Integer
        ...
        Public Overridable Overloads Function GetData() As tbShade
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As tbShade = New tbShade()
        ...
        Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0"),
        Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Overloads Function Update(ByVal dataTable As tbShade) As Integer
        ...
        Public Overridable Overloads Function Delete(ByVal Original_ShadeID As Integer, ByVal Original_Shade As String) As Integer
        ...
        Public Overridable Overloads Function Insert(ByVal Shade As String) As Integer
        ...
        Public Overridable Overloads Function Update(ByVal Shade As String, ByVal Original_ShadeID As Integer, ByVal Original_Shade As String, ByVal ShadeID As Integer) As Integer
            If (Shade Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Shade")
            Else
        ...
        Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),
        Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, True)>
        Public Overridable Overloads Function Update(ByVal Shade As String, ByVal Original_ShadeID As Integer, ByVal Original_Shade As String) As Integer
...
Partial Public Class tbShadeRow
    ...
    Private tabletbShade As tbShade

    <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),
    Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>
    Friend Sub New(ByVal rb As Global.System.Data.DataRowBuilder)
        MyBase.New(rb)
        Me.tabletbShade = CType(Me.Table, tbShade)
    End Sub

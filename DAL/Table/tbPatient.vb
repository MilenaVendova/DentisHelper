...
Partial Public Class tbPatient
    ...
    <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),
    Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>
    Default Public ReadOnly Property Item(ByVal index As Integer) As tbPatientRow
        Get
    ...
    Partial Public Class tbPatientTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "DECLARE @RETURN_VALUE INT; exec @RETURN_VALUE = sp_tbPatient_I  @Name, @BirthDate, @HealthInsuranceNumber, @ShadeID, @Phone, @Email; " &
            "SELECT PatientID , Name , BirthDate , HealthInsuranceNumber , ShadeID , Phone , Email " &
            "FROM tbPatient " &
            ...
            Me._adapter.UpdateCommand.CommandText = "exec sp_tbPatient_U @PatientID, @Name, @Original_Name, @BirthDate, @Original_BirthDate, @HealthInsuranceNumber, @Original_HealthInsuranceNumber, @ShadeID, @Original_ShadeID, @Phone, @Original_Phone, @Email, @Original_Email; " &
            "SELECT PatientID , Name , BirthDate , HealthInsuranceNumber , ShadeID , Phone , Email " &
            "FROM tbPatient " &
        ...
        Public Overridable Overloads Function Fill(ByVal dataTable As tbPatient) As Integer
        ...
        Public Overridable Overloads Function GetData() As tbPatient
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
        ...
        Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0"),
        Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Overloads Function Update(ByVal dataTable As tbPatient) As Integer
        ...
        Public Overridable Overloads Function Insert(ByVal Name As String, ByVal BirthDate As Global.System.Nullable(Of Date), ByVal HealthInsuranceNumber As String, ByVal ShadeID As Global.System.Nullable(Of Integer), ByVal Phone As String, ByVal Email As String) As Integer
        ...
        Public Overridable Overloads Function Update(ByVal Name As String, ByVal BirthDate As Global.System.Nullable(Of Date), ByVal HealthInsuranceNumber As String, ByVal ShadeID As Global.System.Nullable(Of Integer), ByVal Phone As String, ByVal Email As String, ByVal Original_PatientID As Integer, ByVal Original_Name As String, ByVal Original_BirthDate As Global.System.Nullable(Of Date), ByVal Original_HealthInsuranceNumber As String, ByVal Original_ShadeID As Global.System.Nullable(Of Integer), ByVal Original_Phone As String, ByVal PatientID As Integer) As Integer
            If (Name Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Name")
            Else

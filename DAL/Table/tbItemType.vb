...
Partial Public Class tbItemType
    ...
    <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),
    Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>
    Default Public ReadOnly Property Item(ByVal index As Integer) As tbItemTypeRow
        Get
    ...
    Public Overrides Function Clone() As Global.System.Data.DataTable
        Dim cln As tbItemType = CType(MyBase.Clone, tbItemType)
        cln.InitVars()
        Return cln
    End Function
    ...
    Public Sub RemovetbItemTypeRow(ByVal row As tbItemTypeRow)
        Me.Rows.Remove(row)
    End Sub
    Private _ta As tbItemTypeTableAdapter
    Private _dbrm As dbrm

    Public ReadOnly Property TableAdapter() As tbItemTypeTableAdapter
        Get
            If _ta Is Nothing Then
                _ta = New tbItemTypeTableAdapter
            End If
            Return _ta
        End Get
    End Property
    ...
    Partial Public Class tbItemTypeTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "exec sp_tbItemType_D @Original_ItemTypeID"
            ...
            Me._adapter.InsertCommand.CommandText = "DECLARE @RETURN_VALUE INT; exec @RETURN_VALUE = sp_tbItemType_I  @ItemType; " &
            "SELECT ItemTypeID , ItemType " &
            "FROM tbItemType " &
            "WHERE ItemTypeID = @RETURN_VALUE"
            ...
            Me._adapter.UpdateCommand.CommandText = "exec sp_tbItemType_U @ItemTypeID, @ItemType, @Original_ItemType; " &
            "SELECT ItemTypeID , ItemType " &
            "FROM tbItemType " &
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "sp_tbItemType_S"
        ...
        Public Overridable Overloads Function Fill(ByVal dataTable As tbItemType) As Integer
        ...
        Public Overridable Overloads Function GetData() As tbItemType
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As tbItemType = New tbItemType()
        ...
        Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0"),
        Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Overloads Function Update(ByVal dataTable As tbItemType) As Integer
        ...
        Public Overridable Overloads Function Delete(ByVal Original_ItemTypeID As Integer, ByVal Original_ItemType As String) As Integer
        ...
        Public Overridable Overloads Function Insert(ByVal ItemType As String) As Integer
        ...
        Public Overridable Overloads Function Update(ByVal ItemType As String, ByVal Original_ItemTypeID As Integer, ByVal Original_ItemType As String, ByVal ItemTypeID As Integer) As Integer
            If (ItemType Is Nothing) Then
                Throw New Global.System.ArgumentNullException("ItemType")
            Else
        ...
        Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),
        Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, True)>
        Public Overridable Overloads Function Update(ByVal ItemType As String, ByVal Original_ItemTypeID As Integer, ByVal Original_ItemType As String) As Integer
...
Partial Public Class tbItemTypeRow
    ...
    Private tabletbItemType As tbItemType

    <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),
    Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>
    Friend Sub New(ByVal rb As Global.System.Data.DataRowBuilder)
        MyBase.New(rb)
        Me.tabletbItemType = CType(Me.Table, tbItemType)
    End Sub

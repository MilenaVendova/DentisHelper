...
Partial Public Class tbPriorityLevel
    ...
    <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),
    Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>
    Default Public ReadOnly Property Item(ByVal index As Integer) As tbPriorityLevelRow
        Get
    ...
    <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>
    Public Event tbPriorityLevelRowDeleting As tbPriorityLevelRowChangeEventHandler

    <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>
    Public Event tbPriorityLevelRowDeleted As tbPriorityLevelRowChangeEventHandler
    ...
    Public Overrides Function Clone() As Global.System.Data.DataTable
        Dim cln As tbPriorityLevel = CType(MyBase.Clone, tbPriorityLevel)
        cln.InitVars()
        Return cln
    End Function
    ...
    Private Sub InitClass()
        ...
        MyBase.Columns.Add(Me.columnPrioirityLevel)
        Me.Constraints.Add(New Global.System.Data.UniqueConstraint("Constraint1", New Global.System.Data.DataColumn() {Me.columnPriorityILevelD}, True))
        Me.columnPriorityILevelD.AutoIncrement = True
        Me.columnPriorityILevelD.AutoIncrementSeed = -1
        Me.columnPriorityILevelD.AutoIncrementStep = -1
        Me.columnPriorityILevelD.AllowDBNull = False
        Me.columnPriorityILevelD.ReadOnly = True
    ...
    Public Sub RemovetbPriorityLevelRow(ByVal row As tbPriorityLevelRow)
        Me.Rows.Remove(row)
    End Sub
    Private _ta As tbPriorityLevelTableAdapter
    Private _dbrm As dbrm

    Public ReadOnly Property TableAdapter() As tbPriorityLevelTableAdapter
        Get
            If _ta Is Nothing Then
                _ta = New tbPriorityLevelTableAdapter
            End If
            Return _ta
        End Get
    End Property
    ...
    Partial Public Class tbPriorityLevelTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "exec sp_tbPriorityLevel_D @Original_PriorityILevelD"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_PriorityILevelD", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "PriorityILevelD", Global.System.Data.DataRowVersion.Original, False, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_PrioirityLevel", Global.System.Data.SqlDbType.VarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "PrioirityLevel", Global.System.Data.DataRowVersion.Original, False, Nothing, "", "", ""))
            Me._adapter.InsertCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.InsertCommand.CommandTimeout = GS.CommandTimeout
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "DECLARE @RETURN_VALUE INT; exec @RETURN_VALUE = sp_tbPriorityLevel_I  @PrioirityLevel; " &
            "SELECT PriorityILevelD , PrioirityLevel " &
            "FROM tbPriorityLevel " &
            "WHERE PriorityILevelD = @RETURN_VALUE"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@PrioirityLevel", Global.System.Data.SqlDbType.VarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "PrioirityLevel", Global.System.Data.DataRowVersion.Current, False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.UpdateCommand.CommandTimeout = GS.CommandTimeout
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "exec sp_tbPriorityLevel_U @PriorityILevelD, @PrioirityLevel, @Original_PrioirityLevel; " &
            "SELECT PriorityILevelD , PrioirityLevel " &
            "FROM tbPriorityLevel " &
            "WHERE PriorityILevelD = @PriorityILevelD"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "sp_tbPriorityLevel_S"
        ...
        Public Overridable Overloads Function Fill(ByVal dataTable As tbPriorityLevel) As Integer
        ...
        Public Overridable Overloads Function GetData() As tbPriorityLevel
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As tbPriorityLevel = New tbPriorityLevel()
        ...
        Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0"),
        Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Overloads Function Update(ByVal dataTable As tbPriorityLevel) As Integer
        ...
        Public Overridable Overloads Function Delete(ByVal Original_PriorityILevelD As Integer, ByVal Original_PrioirityLevel As String) As Integer
        ...
        Public Overridable Overloads Function Insert(ByVal PrioirityLevel As String) As Integer
        ...
        Public Overridable Overloads Function Update(ByVal PrioirityLevel As String, ByVal Original_PriorityILevelD As Integer, ByVal Original_PrioirityLevel As String, ByVal PriorityILevelD As Integer) As Integer
            If (PrioirityLevel Is Nothing) Then
                Throw New Global.System.ArgumentNullException("PrioirityLevel")
            Else
                Me.Adapter.UpdateCommand.Parameters(0).Value = CType(PrioirityLevel, String)
            End If
            Me.Adapter.UpdateCommand.Parameters(1).Value = CType(Original_PriorityILevelD, Integer)
            If (Original_PrioirityLevel Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_PrioirityLevel")
            Else
        ...
        Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),
        Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, True)>
        Public Overridable Overloads Function Update(ByVal PrioirityLevel As String, ByVal Original_PriorityILevelD As Integer, ByVal Original_PrioirityLevel As String) As Integer
...
Partial Public Class tbPriorityLevelRow
    ...
    Private tabletbPriorityLevel As tbPriorityLevel

    <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),
    Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>
    Friend Sub New(ByVal rb As Global.System.Data.DataRowBuilder)
        MyBase.New(rb)
        Me.tabletbPriorityLevel = CType(Me.Table, tbPriorityLevel)
    End Sub
